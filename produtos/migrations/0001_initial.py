    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('criado_em', models.DateTimeField(auto_now_add=True)),
                ('atualizado_em', models.DateTimeField(auto_now=True)),
                ('nome_social', models.CharField(max_length=100, unique=True, verbose_name='Razao Social do fornecedor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('F', 'Fisico'), ('D', 'Digital')], max_length=1, verbose_name='Tipo de local armazenado')),
            ],
            options={
                'db_table': 'locais',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embalagens', models.ManyToManyField(to='produtos.embalagem', verbose_name='Embalagens do Produtos')),
            ],
            options={
                'db_table': 'produtos',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fornecedor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='produtos.fornecedor', verbose_name='Fornecedor do produto armazenado')),
